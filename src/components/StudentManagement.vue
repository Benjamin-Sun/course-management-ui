<template>
    ...
    <div class="student-management">
        ...
        <div class="operation-area">
            <el-input v-model="searchName" placeholder="请输入学生姓名" style="width: 300px; margin-right: 10px" />
            <el-button type="primary" @click="searchStudent">搜索</el-button>
            <el-button type="success" @click="dialogVisible = true">添加学生</el-button>
        </div>
        ...
        <el-table :data="studentList" border style="width: 100%; margin-top: 20px">
            ...
            <el-table-column label="操作" width="120">
                <template #default="{ row }">
                    <el-button size="small" type="info" @click="showCourses(row.studentName)">查看记录</el-button>
                    <el-button size="small" type="danger" @click="removeStudent(row.studentName)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog v-model="dialogVisible" title="添加学生" width="30%">
            <el-form :model="form" label-width="100px">
                ...
                <el-form-item label="出生日期">
                    <el-date-picker v-model="form.studentBirth" type="datetime" placeholder="选择日期时间"
        ...
        <!-- 新增课程记录对话框 -->
        <el-dialog v-model="courseDialogVisible" title="课程记录" width="60%" top="5vh">
...
const showCourses = async (studentName) => {
    try {
        const { data } = await axios.post('/api/courseManage/schedule/getAllCourses',
